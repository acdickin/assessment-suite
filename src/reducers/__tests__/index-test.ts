...
function initNavigationReducer(){
      ...
      const blankNext = jest.fn();
       ...
       return navigation(undefined,init(config));
}
...
describe('Reducer Tests', () => {
  ...
  it('Should throw an error for unregistered paths', () => {

      let currentState = initNavigationReducer();
      expect(() => {navigation(currentState, fakePushEvent('/main/asdfasd'))}).toThrowError(/Unregistered/);
