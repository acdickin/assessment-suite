...
var person_1 = require("material-ui/svg-icons/social/person");
var styles = {
    bgDiv: {
        position: 'absolute',
        top: 0,
...
var rightNurseIcon = function (props) {
    var alertNurse = props.alertNurse;
    var handleAlertNurse = function (event) {
        event.preventDefault();
        event.stopPropagation();
        alertNurse();
    };
    return (React.createElement(FlatButton_1.default, { style: { width: '120px', color: 'white', backgroundColor: 'red' }, onTouchTap: handleAlertNurse, secondary: true, icon: React.createElement(person_1.default, null) }, "Alert Nurse"));
};
var AppBarPage = (function (_super) {
    ...
    AppBarPage.prototype.render = function () {
        var _a = this.props, categories = _a.categories, pathOnTouchTap = _a.pathOnTouchTap, appConfig = _a.appConfig, leftIcon = _a.leftIcon, flashMessage = _a.flashMessage, appNameShort = _a.appNameShort, appNameLong = _a.appNameLong, alertNurse = _a.alertNurse;
        ...
        return (React.createElement("div", null,
            ...
            !this.state.showAltContent && React.createElement(AppBar_1.default, { title: this.state.title, titleStyle: { textAlign: 'center' }, iconElementLeft: leftIcon, iconElementRight: rightNurseIcon(this.props) }),
...
//# sourceMappingURL=AppBarPage.js.map