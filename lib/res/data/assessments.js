...
var maritalSatisfactionQuestions = [
    ...
    exports.makeQuestion(5, 'Friends', 'text', choicesSet5),
...
var depressionQuestions = [
    exports.makeQuestion('1', 'How often have you been bothered by having little interest or pleasure in doing things?', 'select', choicesSet9),
    exports.makeQuestion('2', 'How often have you been bothered by feeling down, depressed or hopeless?', 'select', choicesSet9),
    exports.makeQuestion('3', 'Over the last two weeks, how often have you been bothered by any of the following problems? ', 'label'),
    exports.makeQuestion('4', 'Trouble falling or staying asleep, or sleeping too much. ', 'select', choicesSet9),
    exports.makeQuestion('5', 'Feeling tired or having little energy.', 'select', choicesSet9),
    exports.makeQuestion('6', 'Poor appetite or overeating.', 'select', choicesSet9),
    exports.makeQuestion('7', 'Feeling bad about yourself – or that  you are a failure or have let yourself or your family down. ', 'select', choicesSet9),
    exports.makeQuestion('8', 'Trouble concentrating on things, such as reading the newspaper or watching television.  ', 'select', choicesSet9),
    ...
    exports.makeQuestion('10', 'Thoughts that you would be better off dead, or of hurting yourself in some way. ', 'select', choicesSet9)
];
...
exports.AlchoholDrugsAssessment = exports.makeAssessment(6, 'Alcohol and Drugs', 0, 22, 38, AlcoholDrugsList, 0, alcDrugsQuestions, alcImage, calcAlcDrugQuestions, calcDrugsScore);
exports.PTSAssessment = exports.makeAssessment(7, 'Post-Traumatic Stress', 17, 39, 85, PostTraumaticStressList, 0, ptsQuestions, ptsImage);
...
var assessmentsRaw = [
    ...
    exports.AlchoholDrugsAssessment,
    exports.PTSAssessment,
