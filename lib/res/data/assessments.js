...
exports.makeAssessment = function (id, title, minScore, middleScore, maxScore, scoring, scoringMode, questions, image, calcQuestions, calcScore) {
...
var friendsImage = path.resolve('../images/Friendship_Scale.jpg');
var marriageImage = path.resolve('../images/Marital_Satisfaction.jpg');
var socialImage = path.resolve('../images/Perceived_Social_Support.jpg');
var postDepSocialImage = path.resolve('../images/Post_Deployment_Social_Support.jpg');
var parentingConfidenceImage = path.resolve('../images/Parenting_Confidence.jpg');
