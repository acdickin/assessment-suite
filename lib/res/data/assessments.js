...
var stressScoringList = [
    exports.makeScoring(47, 0, 10, 'Low Acuity', //TODO find copy for conclusions
    "<p>Your score is in a range typically associated with LOW stress.</p>", "<p>Although only a healthcare professional can provide an actual diagnosis, your results suggest that you don\u2019t seem to be having difficulties with stress right now.</p>"),
    exports.makeScoring(48, 11, 25, 'Moderate Acuity', "<p>Your score is in a range typically associated with MODERATE stress.</p>", "<p>Although only a healthcare professional can provide an actual diagnosis, stress may be causing significant problems in your relationships, your work, and your health.</p>"),
    exports.makeScoring(49, 26, 40, 'High Acuity', "<p>Your score is in a range typically associated with HIGH stress.</p>", "<p>Although only a healthcare professional can provide an actual diagnosis, your responses suggest you may be feeling stress often or having problems controlling your stress.</p>")
];
var stigmaScoringList = [
    exports.makeScoring(47, 10, 22, 'Low Stigma', //TODO find copy for conclusions
    "<p>Your results indicate that you are comfortable with the idea of seeking psychological treatment.</p>", "<p>Your results suggest you are managing this area of your life. Because maintaining healthy habits means following a lifestyle that includes stress management and finding balance, we encourage you to check out the many tools in the \"Life Stress\" topic.</p>\n<p>You are also encouraged to check out other assessments on AfterDeployment to learn if you are having problems in some areas. You can find links to these tools under the RESOURCES tab located above. </p>\n<p>You may find it helpful to join the AfterDeployment Facebook page where you can network with others on a range of topics.</p>"),
    exports.makeScoring(48, 23, 32, 'Medium Stigma', "<p>Your results indicate that you are somewhat uncomfortable with the idea of seeking psychological treatment.</p>", "<p>Discomfort with the idea of seeking psychological treatment for problems in living is not unusual. Reluctance to meet with a mental health professional however is often the result of a lack of information or misinformation about the treatment process. Counseling, \n                psychotherapy, and medication management are now based on research and have been shown to be very effective for a wide range of psychological health issues from depression to relationship problems. Failure to get needed treatment for the effects of stress or other \n                issues can lead to increasing problems with your physical health, your emotional well-being, and your relationships. If you are experiencing depression, anxiety, or other psychological distress, you need to get help. Start with your physician or clergy. You can \n                locate a provider or a clinic near you by clicking on the LOCATE tab in the upper right corner of the main page. We recommend you take a copy of the results of this assessment and share them during your appointment.</p>\n                <p>\n                  We encourage you to check out the materials in AfterDeployment is \"Stigma\" topic.\n                </p>\n                <p>\n                  If you are concerned about seeking psychological treatment, you may wish to explore the kinds of problems that may be present in other areas of life. You can determine where other problems may exist or the extent of the problem by taking additional assessments.\n                </p>\n                <!--<p>You can find links to these tools under the RESOURCES tab located above.</p>-->\n                  <p>You may find it helpful to join the AfterDeployment Facebook page where you can network with others on a range of topics.</p>\n                "),
    exports.makeScoring(49, 33, 50, 'High Stigma', "<p>Your results indicate that you are highly uncomfortable with the idea of seeking psychological treatment.</p>", "<p>Discomfort with the idea of seeking psychological treatment for problems in living is not unusual. Reluctance to meet with a mental health professional however is often the result of a lack of information or misinformation about the treatment process. Counseling, \n                psychotherapy, and medication management are now based on research and have been shown to be very effective for a wide range of psychological health issues from depression to relationship problems. Failure to get needed treatment for the effects of stress or other \n                issues can lead to increasing problems with your physical health, your emotional well-being, and your relationships. If you are experiencing depression, anxiety, or other psychological distress, you need to get help. Start with your physician or clergy. You can \n                locate a provider or a clinic near you by clicking on the LOCATE tab in the upper right corner of the main page. We recommend you take a copy of the results of this assessment and share them during your appointment.</p>\n                <p>\n                  We encourage you to check out the materials in AfterDeployment is \"Stigma\" topic.\n                </p>\n                <p>\n                  If you are concerned about seeking psychological treatment, you may wish to explore the kinds of problems that may be present in other areas of life. You can determine where other problems may exist or the extent of the problem by taking additional assessments.\n                </p>\n                <!--<p>You can find links to these tools under the RESOURCES tab located above.</p>-->\n                  <p>You may find it helpful to join the AfterDeployment Facebook page where you can network with others on a range of topics.</p>\n                ")
];
var worryScoringList = [
    exports.makeScoring(23, 0, 39, 'LOW', "<p>Your score is in a range typically associated with a low level of worry indicating that chronic worry is probably not affecting your life.</p>", "<p>Although only a healthcare professional can provide an actual diagnosis of an anxiety disorder, your results suggest that you are not likely to engage in catastrophic thinking and that you can accurately evaluate the likelihood of negative events occurring in your life.</p>"),
    exports.makeScoring(24, 40, 59, 'MODERATE', "<p>Your score is in a range typically associated with a moderate level of worry indicating that worry may be causing you some level of distress.</p>", "<p>Although only a healthcare professional can provide an actual diagnosis, your responses suggest you may be prone to some degree of unrealistic concern about bad things happening in your life.</p>"),
    exports.makeScoring(25, 59, 80, 'HIGH', "<p>Your score is in a range typically associated with a high level of worried thinking and anxiety.</p>", "<p>Although only a healthcare professional can provide an actual diagnosis, worry may be causing you significant distress.</p>")
];
...
exports.StressAssessment = exports.makeAssessment(14, 'Stress', 0, 18, 40, stressScoringList, 0, stressQuestions, stressImage);
exports.StigmaAssessment = exports.makeAssessment(15, 'Stigma', 10, 27.5, 50, stigmaScoringList, 0, stigmaQuestions, stigmaImage);
exports.WorryAssessment = exports.makeAssessment(16, 'Worry', 16, 38, 80, worryScoringList, 0, worryAssessmentQs, stigmaImage);
var assessmentsRaw = [
