...
exports.createPlainRoutes = function (config, cb) {
    var asyncRoute = helper_1.asynRouteMaker({});
    var _a = initConfig(config, cb), AssessmentList = _a.AssessmentList, AssessmentPage = _a.AssessmentPage;
    var AssessmentPageRoute = asyncRoute('assessment/:id', System.import('../containers/AssessmentPage'));
    var AssessmentsRoute = asyncRoute('assessments', System.import('../containers/AssessmentList'));
    return {
        AssessmentPageRoute: AssessmentPageRoute,
