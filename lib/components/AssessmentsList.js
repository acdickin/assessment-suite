...
var AssessmentsList = (function (_super) {
    ...
    function AssessmentsList(props) {
        ...
        _this.renderAssessment = function (rProps) {
            var children = !Array.isArray(_this.props.children) ? [_this.props.children] : _this.props.children;
            var content = children.map(function (item, index) {
                return React.cloneElement(item, { key: index, mode: 'default', onAssessmentMounted: _this.props.onAssessmentMounted, setPageTitle: _this.props.setPageTitle, onCancel: _this.handleItemCancel, itemClick: _this.handleItemClick, selectedId: parseInt(rProps.match.params.id) });
            });
    ...
    AssessmentsList.defaultProps = {
        ...
        onAssessmentMounted: function (assessment) { }
    };
