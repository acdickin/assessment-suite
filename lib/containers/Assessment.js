...
var Assessment = (function (_super) {
    ...
    Assessment.prototype.render = function () {
        ...
        if (this.state.isComplete) {
            ...
            content = React.createElement(Assessment_1.default, { item: item, values: this.handleFormValues(), cancel: this.handleCancel, onSubmit: this.handleSubmitData, validateData: this.handleValidateData });
        }
